...
private:
	...
	Base::DataStreamIn <cv::Mat, Base::DataStreamBuffer::Newest> in_img_left;
	Base::DataStreamIn <Types::CameraInfo, Base::DataStreamBuffer::Newest> in_camera_info_left;
	Base::DataStreamOut <cv::Mat> out_img_left;
	
	Base::DataStreamIn <cv::Mat, Base::DataStreamBuffer::Newest> in_img_right;
	Base::DataStreamIn <Types::CameraInfo, Base::DataStreamBuffer::Newest> in_camera_info_right;
	Base::DataStreamOut <cv::Mat> out_img_right;

	Types::CameraInfo camera_info_left, camera_info_right;
...
REGISTER_COMPONENT("Undistort", Processors::CvUndistort::CvUndistort_Processor)
